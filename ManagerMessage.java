...
public class ManagerMessage extends JPanel 
{
	JButton Button1 = new JButton("修改个人信息");
	JButton Button2 = new JButton("修改密码");

	static String mnum=ManagerEnter.name;
	static String sql="SELECT * FROM manager where id ='"+mnum+"'";
	 ...
	 class listener implements ActionListener 
	  {
		public void actionPerformed(ActionEvent e)
		{
			...
			{
				ManagerModify dialog = new ManagerModify();
			    ...
			    {
					ManagerpwModify dialog0=new ManagerpwModify();
...
class ManagerModify extends JDialog implements ActionListener
{
	...
	String mnum=ManagerEnter.name;
	String sql="SELECT * FROM manager where id ='"+mnum+"'";
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if (e.getSource()==b1)
		{
		    ...
		    { 
		        ...
		        { 
		          String sql="UPDATE manager SET name ='"+t1.getText()+"', sex= '"+t2.getText()
		          +"',age='"+t3.getText()+"',telephone='"+t4.getText()+"' WHERE id = '"+mnum+"' "; 
		          
		          new ConnectDB().Update(sql); 
		          
		            String mnum0=ManagerEnter.name;
					String sql1="SELECT * FROM manager where id ='"+mnum0+"'";
					String message[][]=new ConnectDB().Select(sql1);
					
					ManagerMessage.La1.setText(message[0][0]);
					ManagerMessage.La2.setText(message[0][1]);
					ManagerMessage.La3.setText(message[0][2]);
					ManagerMessage.La4.setText(message[0][3]);
					ManagerMessage.La5.setText(message[0][4]);
...
class ManagerpwModify extends JDialog implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if (e.getSource()==b1)
		{
			...
			{
				if(!t1.getText().equals((message[0][5])))
			    {
				//System.out.println("输入失败"); 
			   ...
			   {	   
		           ...
		           { 
		             ...
		             if (n == JOptionPane.YES_OPTION) 
		             { 
		               String sql="UPDATE manager SET password ='"+t2.getText()+"' WHERE id = '"+mnum+"' "; 
